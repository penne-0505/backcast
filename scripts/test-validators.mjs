...
- **Title**: [Feat] Planned QA
- **ID**: Core-Feat-1
- **Risk**: High
- **Intent**: None
- **QA**: _docs/qa/Core/planned-qa/test-plan.md
- **Verification**: _docs/qa/Core/planned-qa/verification.md
...
ok = await (async () => {
  ...
  console.error("FAIL qa rejects canonical future QA refs in Backlog");
  return false;
})() && ok;
