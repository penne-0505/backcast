...
const documentationGuide = await read("_docs/documentation_guide.md");
...
assert(
  contains(
    documentationGuide,
    "Template release の継続更新",
    "pre-`v1.0.0` project",
    "推奨 tag へ直接移行",
    "`DD_SCOPE_BASE` は導入先の validator scope",
  ) &&
    contains(
  ...
  "project reader docs separate template provenance, legacy bootstrap, and validator scope",
);
