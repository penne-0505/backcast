...
18. ヘッダーの表示密度アイコンをタップして、吸い付き付きスライダーで編集ビューの時間軸の広さを調整する。スライダーは他のヘッダー操作やタイムライン操作へ移ると閉じる
...
- 表示密度: 編集ビューの `pixelsPerMinute` を 3.0〜6.0 の 0.5 刻みで調整する一時 UI 状態です。長時間計画の全体把握には Compact Overview を使い、表示密度は編集ビューでの読みやすさと細かさの調整に使います
